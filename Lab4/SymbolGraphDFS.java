...
public class SymbolGraphDFS {
   ...
   //delimiter the delimiter between fields.
	public SymbolGraphDFS(File file, String delimiter) {
   ...
   //Returns the graph associated with the symbol graph.
	...
	public static void main(String[] args) throws MalformedURLException {
    	...
    	String delimiter = " ";
    	SymbolGraphDFS d = new SymbolGraphDFS(file, delimiter);
    ...
    System.out.println("Find the path from : ");
     ...
     //check there is path or not
    	if(dfs.hasPathTo(to)) {
    		for(Integer i : dfs.pathTo(to))
    			System.out.println(d.name(i)); //if there is a path prints the name
    	}	
    		else
